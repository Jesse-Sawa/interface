...
const BG_COLORS_BY_DARK_MODE_AND_CHAIN_ID: {
  ...
  dark: {
    ...
    [SupportedChainId.POLYGON_MUMBAI]:
      'radial-gradient(100% 93.36% at 0% 6.64%, rgba(160, 108, 247, 0.1) 0%, rgba(82, 32, 166, 0.1) 100%)',
    [SupportedChainId.CELO]: 'rgba(53, 208, 127, 0.05)',
    [SupportedChainId.CELO_ALFAJORES]: 'rgba(53, 208, 127, 0.05)',
  ...
  light: {
    ...
    [SupportedChainId.POLYGON_MUMBAI]:
      'radial-gradient(182.71% 205.59% at 2.81% 7.69%, rgba(130, 71, 229, 0.2) 0%, rgba(167, 202, 255, 0.2) 100%)',
    [SupportedChainId.CELO]: 'rgba(53, 208, 127, 0.2)',
    [SupportedChainId.CELO_ALFAJORES]: 'rgba(53, 208, 127, 0.2)',
    [SupportedChainId.OPTIMISM]:
...
const TEXT_COLORS: { [chainId in NetworkAlertChains]: string } = {
  ...
  [SupportedChainId.CELO]: 'rgba(30, 228, 129, 1)',
